...
export const getMenuByModeGroupBy = (modeId, groupBy, page, size, area) => {
  return axios.get(
    `${BASE_URL}${MENU}/filter?modeId=${modeId}&areaId=${area}&gb=${groupBy}&page=${page}&pageSize=${size}`,
    {
...
//https://deliveryvhgp-webapi.azurewebsites.net/api/v1/menus/now/categoies?modeId=1&areaId=1
export const getMenuByMode = (modeId, area) => {
  return axios.get(
    `${BASE_URL}${MENU}/now/categoies?modeId=${modeId}&areaId=${area}`,
    {
      Accept: 'application/json',
      'Content-Type': 'application/json',
    }
...
//https://deliveryvhgp-webapi.azurewebsites.net/api/v1/menus/now/storeCategories?modeId=1&areaId=1&storeCateSize=1&storeSize=20
export const getListStoreCategory = (modeId, page, size, area) => {
  return axios.get(
    `${BASE_URL}${MENU}/now/storeCategories?modeId=${modeId}&areaId=${area}&storeCateSize=${page}&storeSize=${size}`,
    {
      Accept: 'application/json',
      'Content-Type': 'application/json',
    }
...
export const getListStoreInMenuByMode = (modeId, page, size, area) => {
  return axios.get(
    `${BASE_URL}${MENU}/now/stores?modeId=${modeId}&areaId=${area}&page=${page}&pageSize=${size}`,
    {
      Accept: 'application/json',
      'Content-Type': 'application/json',
    }
