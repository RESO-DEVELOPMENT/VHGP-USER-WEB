...
export const OrderDetailPage = () => {
  const { setIsHeaderOrder, mobileMode, setHeaderInfo, mode } =
  ...
  const getOpacity = (status) => {
    ...
    if (status && status.name) {
      if (
        status.name === STATUS_ORDER[0].compare ||
        status.name === STATUS_ORDER[1].compare ||
        status.name === STATUS_ORDER[2].compare ||
        status.name === STATUS_ORDER[3].compare
      ) {
        opacity = 1;
      } else {
        opacity = 0.3;
    ...
    <>
      ...
      <section className="" style={{ paddingTop: 70, paddingBottom: 70 }}>
          ...
          <div style={{ flexDirection: "column" }} className="f_flex">
            <div className="" style={{ display: "block" }}>
              ...
              >
                ...
                >
                  <i
                    style={{ color: "var(--primary)", lineHeight: 1.3 }}
                ...
                >
                  ...
                  <div className="flex-collumn">
                    ...
                    <span>
                      Building {orderInfo.buildingName} Vinhomes Green Park
                    </span>
                  </div>
                </div>
              </div>
              ...
              <div className="order-wrapper" style={{ flex: 0.65 }}>
                ...
                <div className="f_flex" style={{ gap: 20 }}>
                  ...
                  >
                    ...
                    <div
                      className="line"
                      style={{ opacity: getOpacity(statusOrder[1]) }}
                    ></div>
                    ...
                    <div
                      className="line"
                      style={{ opacity: getOpacity(statusOrder[2]) }}
                    ></div>
                    ...
                    <div
                      className="line"
                      style={{ opacity: getOpacity(statusOrder[3]) }}
                    ></div>
                  ...
                  >
                    <div
                      ...
                      style={{ opacity: getOpacity(statusOrder[0]) }}
                    >
                      <img
                      ...
                      <div
                        className="f_flex"
                        style={{ flexDirection: "column", paddingLeft: 4 }}
                      >
                        <span className="status-info-time">
                          {validStatus(statusOrder[0])}
                        </span>
        ...
        <div className="container" style={{ marginTop: 10, padding: "0 10px" }}>
          ...
          >
            <span style={{ fontWeight: 600, fontSize: mobileMode ? 16 : 18 }}>
              Tiếp tục mua hàng
            </span>
          </div>
        </div>
